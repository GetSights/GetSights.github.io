/*
{
  question: 'How can I find sightseeing inside the custom area?',
  answer: [
    '1. Go to Home screen',
    '2. Press white button with pencil icon on the right-bottom corner of the map',
    '3. Draw some shape on the map',
    '4. Press by "Search in this area" button.',
    'Sightseeing will appear on the grid below the map, if you can not see them, please draw another shape on the map.',
    'To remove custom area search just press to white button with basket icon on the right-bottom corner of the map.',
    getYoutubeVideoMarkup('tgbNymZ7vqY'),
  ],
},
{
  question: 'How can I remove photo from my own route?',
  answer: [
    'Just press by yellow star icon and item from route will disappear',
  ],
},
{
  question: 'How can I reset my own route?',
  answer: [
    'To reset route, just press by filter between map and list of photos, then inside modal with options select <strong>Reset current route</strong> option',
  ],
},
{
  question: 'How can I see photos inside my own route?',
  answer: [
    'To see photos inside route route, you should move to Map screen just press by second item with map icon inside bottom navigator.\nThen you can see list of photos inside route.\nAlso you can see each photo on full screen mode.',
  ],
},
{
  question: 'How can I use filter to find photos and routes?',
  answer: [
    'There are three options to filter photos.\n<strong>By popular photos</strong>\n<strong>By new photos</strong>\n<strong>By only my photos.</strong>\nAnd one for routes.\n<strong>Routes inside this area</strong>\nBy only my photos option will appear only for logged in users',
    'To filter photos and routes just press filter between map and list of photos and select appropriate option.',
  ],
},

{
  question: 'How many photos I can add to route?',
  answer: [
    'No more than 10 photos can be added to one route.',
    'This is the Google limitation. We are trying to make <strong>GetSights</strong> free, so we are using Google restrictions by default.',
  ],
},
{
  question: 'How can I change photos positions inside the route?',
  answer: [
    'Each photo has arrows left and right, to display it needs to press by photo inside list of photos.',
  ],
},
{
  question: 'How can I sort photos inside the route?',
  answer: [
    'Currently we support only to types of sort. First type is <strong>Sort by first point</strong> and second one is <strong>Sort by current location</strong>',
    'To sort route move to Map screen, then press by white button with sliders icon on the right-bottom corner of the map and select appropriate option.',
  ],
},

{
  question: 'Why route displayed inside Google maps but not in the GetSights app?',
  answer: [
    'We are trying to make <strong>GetSights</strong> free so it is a main point why we do not use Google API inside <strong>GetSights</strong> but open route inside Google maps instead.',
  ],
},

// Upload screen
{
  question: 'How can I upload a new photo if previous one did not upload?',
  answer: [
    'To upload a new photo just reset previous one by pressing arrow left button at the top left screen, then upload new photo.',
  ],
},
{
  question: 'Why I can not fill upload inputs?',
  answer: [
    'You just need to upload photo and then you can fill inputs.',
  ],
},
{
  question: 'Why should I set correct point address while uploading photo?',
  answer: [
    'It\'s important for us and our users to have correct address on each of photo to have possibility to visit this place in the future.',
  ],
},
{
  question: 'Can I skip setting correct point address while uploading photo?',
  answer: [
    'No, you can not skip this step of uploading photo.',
    'It\'s important for us and our users to have correct address on each of photo to have possibility to visit this place in the future.',
  ],
},
{
  question: 'Why should I set point category while uploading photo?',
  answer: [
    'It\'s important for us and our users to have category on each of photo to have possibility to make searching sightseeing easy.',
  ],
},
{
  question: 'Can I skip setting point category while uploading photo?',
  answer: [
    'It\'s important for us and our users to have category on each of photo to have possibility to make searching sightseeing easy.',
  ],
},
{
  question: 'Why should I add Name while uploading photo?',
  answer: [
    'It\'s important for us and our users to have name or instagram login on each of photo to have possibility to see the photo author.',
  ],
},
{
  question: 'Can I skip setting Name while uploading photo?',
  answer: [
    'Yes, you can. But if you skip entering your name you should enter your Instagram login instead. This is necessary in order to see the photo author.',
  ],
},
{
  question: 'Why should I add Instagram login while uploading photo?',
  answer: [
    'It\'s important for us and our users to have name or instagram login on each of photo to have possibility to see the photo author.',
  ],
},
{
  question: 'Can I skip setting Instagram while uploading photo?',
  answer: [
    'Yes, you can. But if you skip entering your Instagran login you should enter your Name instead. This is necessary in order to see the photo author.',
  ],
},
{
  question: 'Why should I add point description while uploading photo?',
  answer: [
    'It would be great to have some small photo description on each of photo to have possibility to understand what is in the photo.',
  ],
},
{
  question: 'Can I skip setting point description while uploading photo?',
  answer: [
    'Yes, you can. But if you skip entering description some users can\'t understand what is in the photo.',
  ],
},
{
  question: 'Can I cancel uploading photo?',
  answer: [
    'Yes, you can. You just need to press blue <strong>Cancel</strong> button.',
  ],
},
{
  question: 'Can I change filled inputs in future?',
  answer: [
    'Yes, you can. You just need to move to the Profile screen then list with photo will appear. Press by photo - modal with full screen photo will appear. Press by three dots on the top right screen corner and popup with options will appear. Just press to <strong>Update</strong> button and now you can update your data.',
  ],
},
// Profile screen
{
  ...
  answer: [
    'You just need to move to the Profile screen then list with login buttons will appear. Select your appropriate provider to login and then press by choosen provider button and enter your credentials.',
  ],
},
{
  question: 'How can I log out from my account?',
  answer: [
    'You just need to move to the Profile screen then press by three dots on the top right screen corner and popup with options will appear. Just press to <strong>Log out</strong> button and now you can log out.',
  ],
},
{
  question: 'How can I remove my photo?',
  answer: [
    'You just need to move to the Profile screen then list with photo will appear. Press by photo - modal with full screen photo will appear. Press by three dots on the top right screen corner and popup with options will appear. Just press to <strong>Remove</strong> button.',
  ],
},
{
  question: 'How can I update data of my photo?',
  answer: [
    'You just need to move to the Profile screen then list with photo will appear. Press by photo - modal with full screen photo will appear. Press by three dots on the top right screen corner and popup with options will appear. Just press to <strong>Update</strong> button and now you can update your data.',
  ],
},
{
  question: 'How can I rename my route\'s name?',
  answer: [
    'You just need to move to the Profile screen then select <strong>My Routes</strong> tab and list with routes will appear. Press by route - modal with route will appear. Press by three dots on the top right screen corner and popup with options will appear. Just press to <strong>Rename</strong> button.',
  ],
},
{
  question: 'How can I remove my route?',
  answer: [
    'You just need to move to the Profile screen then select <strong>My Routes</strong> tab and list with routes will appear. Press by route - modal with route will appear. Press by three dots on the top right screen corner and popup with options will appear. Just press to <strong>Remove</strong> button.',
  ],
},
{
  question: 'If I like some routes, can I use it?',
  answer: [
    'Yes, you can. You can share it with friends and open it on the map navigator.',
  ],
},
*/
